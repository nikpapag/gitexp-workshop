...
public class DevelopersController {
	...
	public String Engineer(@PathVariable Long id, Model model) {
		model.addAttribute("developer", repository.getOne(id));
		model.addAttribute("skills", skillRepository.findAll());
		return "developer";
	}
	...
	public String EngineerssList(Model model) {
		model.addAttribute("developers", repository.findAll());
		return "developers";
	}

	@RequestMapping(value="/Engineers",method=RequestMethod.POST)
	public String EngineersAdd(@RequestParam String email, 
						@RequestParam String firstName, @RequestParam String lastName, Model model) {
		Developer newDeveloper = new Developer();
		newDeveloper.setEmail(email);
		newDeveloper.setFirstName(firstName);
	...
	@RequestMapping(value="/Engineers/{id}/skills", method=RequestMethod.POST)
	public String EngineersAddSkill(@PathVariable Long id, @RequestParam Long skillId, Model model) {
		Skill skill = skillRepository.getOne(skillId);
		Developer developer = repository.getOne(id);
